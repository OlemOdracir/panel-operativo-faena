...
export const esCL = {
  ...
  dashboard: {
    ...
    incidentsToManage: 'Incidentes que requieren atención',
    incidentTableDescription: 'Prioriza por área, severidad, lectura y antigüedad.',
    showing: (visible: number, total: number) => `Mostrando ${visible} de ${total} incidentes`,
    noMatchingIncidents: 'No hay incidentes que coincidan con los filtros.',
    incident: 'Incidente',
    sensor: 'Sensor',
    area: 'Área',
    readingRange: 'Lectura / rango',
    severity: 'Severidad',
    status: 'Estado',
    age: 'Antigüedad',
